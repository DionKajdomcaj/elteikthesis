...
If the git prerequisite is met, we can clone the repositery by
...
will fulfill all the requirements to run the application.
\newline
...
\begin{figure}[H]
	...
	\subcaptionbox{Account Actions}{
		\includegraphics[width=0.45\linewidth, height=240px]{images/accountaction.png}}
	\hspace{5pt}
	\subcaptionbox{Domain Actions}{
		\includegraphics[width=0.45\linewidth, height=240px]{images/domainaction.png}}
