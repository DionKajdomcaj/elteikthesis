...
\begin{itemize}
	\item \textbf{Mastodon username or email}, which is your original Mastodon account username.
...
like: \textbf{\url{example@mastodon.elte.hu}} then the username is example and the server is
mastodon.elte.hu. All of the data are case sensitive, so you must give them
